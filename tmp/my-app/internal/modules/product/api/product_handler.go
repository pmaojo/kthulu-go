...
import (
	...
	"my-app/internal/modules/product/core"
...
func NewProductHandler(service core.ProductService) *ProductHandler {
...
// @Accept       json
// @Produce      json
// @Param        input body core.Product true "Product object"
