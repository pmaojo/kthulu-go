...
import (
	...
	"verify-debug/internal/core"
 "verify-debug/internal/modules/user"
 userCore "verify-debug/internal/modules/user/core"
 userAPI "verify-debug/internal/modules/user/api"
 "verify-debug/internal/modules/auth"
 authCore "verify-debug/internal/modules/auth/core"
 authAPI "verify-debug/internal/modules/auth/api"
)
...
func runApplication(ctx context.Context, builder func(http.Handler) httpServer) error {
	...
	app := fx.New(
		...
		fx.Invoke(func(lc fx.Lifecycle, router *mux.Router, userService userCore.UserService, authService authCore.AuthService) {
