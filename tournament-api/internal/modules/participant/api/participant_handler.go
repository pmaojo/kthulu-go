...
// RegisterRoutes registers all routes for participant
func (h *ParticipantHandler) RegisterRoutes(router *mux.Router) {
	sub := router.PathPrefix("//participant").Subrouter()
...
// Create handles the creation of a new participant
...
// GetByID retrieves a participant by its ID
...
// Update handles the update of a participant
...
// Delete handles the deletion of a participant
...
// List retrieves all participants
