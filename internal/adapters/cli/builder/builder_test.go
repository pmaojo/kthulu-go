...
func TestGenerateProducesCompiledAndContracts(t *testing.T) {
	...
	plan := Plan{
		Replacements: []Replacement{
			{
				Interface:      "github.com/pmaojo/kthulu-go/internal/adapters/cli/builder/testdata/interfaces.Service",
				Implementation: "github.com/pmaojo/kthulu-go/internal/adapters/cli/builder/testdata/overrides.MockService",
				Constructor:    "github.com/pmaojo/kthulu-go/internal/adapters/cli/builder/testdata/overrides.NewMockService",
			},
		},
		Decorations: []string{
			"github.com/pmaojo/kthulu-go/internal/adapters/cli/builder/testdata/decorator.DecorateService",
		},
		Groups: map[string][]string{
			"hooks": []string{"github.com/pmaojo/kthulu-go/internal/adapters/cli/builder/testdata/hooks.NewHook"},
		},
	}
...
func TestGenerateContractFails(t *testing.T) {
	...
	plan := Plan{
		Replacements: []Replacement{
			{
				Interface:      "github.com/pmaojo/kthulu-go/internal/adapters/cli/builder/testdata/interfaces.Service",
				Implementation: "github.com/pmaojo/kthulu-go/internal/adapters/cli/builder/testdata/badoverride.BadService",
				Constructor:    "github.com/pmaojo/kthulu-go/internal/adapters/cli/builder/testdata/badoverride.NewBadService",
			},
		},
	}
	planPath := filepath.Join(outDir, "plan.json")
