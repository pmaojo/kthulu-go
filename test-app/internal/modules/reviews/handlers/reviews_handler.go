...
// RegisterRoutes registers all routes for reviews
...
// Create handles the creation of a new reviews
// @Summary      Create a new reviews
// @Description  Creates a new reviews with the provided data
// @Tags         Reviews
// @Accept       json
// @Produce      json
...
// GetByID retrieves a reviews by its ID
// @Summary      Get reviews
// @Description  Get a reviews by its ID
// @Tags         Reviews
// @Accept       json
// @Produce      json
...
// Update handles the update of a reviews
...
// Delete handles the deletion of a reviews
