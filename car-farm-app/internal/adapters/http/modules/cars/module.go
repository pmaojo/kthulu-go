...
import (
	...
	"car-farm-app/internal/adapters/http/modules/cars/handlers"
	"car-farm-app/internal/adapters/http/modules/cars/repository"
	"car-farm-app/internal/adapters/http/modules/cars/service"
)
