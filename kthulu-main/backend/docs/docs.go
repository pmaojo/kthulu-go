...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/api/calendar/appointments/available-slots": {
            "get": {
        ...
        "/api/calendar/appointments/book": {
            "post": {
        ...
        "/api/calendar/business-day/{date}": {
            "get": {
        ...
        "/api/inventory/items/{warehouseId}/{productId}": {
            "get": {
        ...
        "/api/inventory/movements/{inventoryItemId}": {
            "get": {
        ...
        "/contacts/{contactId}/convert-to-customer": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/invoices": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Include invoice items",
                        "name": "includeItems",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "Include invoice payments",
        ...
        "/products": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Filter by trackable status",
                        "name": "isTrackable",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Sort by field (name, sku, category, brand, created_at, updated_at)",
                        "name": "sortBy",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "boolean",
                        "description": "Include product prices",
                        "name": "includePrices",
                        "in": "query"
                    }
                ],
        ...
        "/products/{productId}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Include related data (variants,prices)",
                        "name": "include",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "backend_internal_domain.AvailabilitySlot": {
            ...
            "properties": {
                ...
                "slotType": {
                    "description": "appointment, meeting, etc.",
                    "type": "string"
                },
                "startTime": {
                    "type": "string"
        ...
        "backend_internal_domain.Booking": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "confirmed, canceled, completed",
                    "type": "string"
                },
                "updatedAt": {
                    "type": "string"
        ...
        "backend_internal_repository.ProductStats": {
            ...
            "properties": {
                ...
                "recentProducts": {
                    "description": "Products created in last 30 days",
                    "type": "integer"
                },
                "totalBrands": {
                    "type": "integer"
        ...
        "backend_internal_usecase.UpdateStockRequest": {
            ...
            "properties": {
                "adjustmentType": {
                    "description": "for adjustments: set, increase, decrease",
                    "type": "string"
                },
                "minimumStock": {
                    "type": "integer",
