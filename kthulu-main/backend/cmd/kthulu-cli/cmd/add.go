...
import (
	...
	"backend/cmd/kthulu-cli/internal/generator"
...
`, name, name, name, strings.Title(name), strings.Title(name), strings.Title(name))
}
...
`, name, strings.Title(name), name, strings.Title(name),
		strings.Title(name), strings.Title(name), strings.Title(name),
		strings.Title(name), strings.Title(name), strings.Title(name),
		strings.Title(name), strings.Title(name), strings.Title(name),
		strings.Title(name), strings.Title(name), strings.Title(name),
...
`, name, name, strings.Title(name), strings.Title(name), strings.Title(name),
		strings.Title(name), strings.Title(name), strings.Title(name),
		strings.Title(name), strings.Title(name), strings.Title(name),
		strings.Title(name), strings.Title(name), strings.Title(name),
		strings.Title(name), strings.Title(name), strings.Title(name), strings.Title(name))
...
func (s *%sService) List%ss() ([]*domain.%s, error) {
	return s.repo.List()
}
`, name, name, strings.Title(name), strings.Title(name), strings.Title(name),
		strings.Title(name), strings.Title(name), strings.Title(name),
...
func (h *%sHandler) List(w http.ResponseWriter, r *http.Request) {
	entities, err := h.service.List%ss()
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
