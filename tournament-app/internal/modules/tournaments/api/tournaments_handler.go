...
// RegisterRoutes registers all routes for tournaments
...
// Create handles the creation of a new tournaments
// @Summary      Create a new tournaments
// @Description  Creates a new tournaments with the provided data
// @Tags         Tournaments
// @Accept       json
// @Produce      json
...
// GetByID retrieves a tournaments by its ID
// @Summary      Get tournaments
// @Description  Get a tournaments by its ID
// @Tags         Tournaments
// @Accept       json
// @Produce      json
...
// Update handles the update of a tournaments
...
// Delete handles the deletion of a tournaments
...
// List retrieves all tournamentss
