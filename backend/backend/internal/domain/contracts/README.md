...
go test -v -run TestRepositoryContracts ./internal/domain/contracts/

# HTTP contracts only
go test -v -run TestHTTPContracts ./internal/domain/contracts/

# Interface compliance only
go test -v -run TestBasicRepositoryContracts ./internal/domain/contracts/
```
