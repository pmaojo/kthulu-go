...
import (
	...
	"airbnb-v2/internal/core"
 "airbnb-v2/internal/modules/booking"
 bookingDomain "airbnb-v2/internal/modules/booking/domain"
 bookingHandlers "airbnb-v2/internal/modules/booking/handlers"
 "airbnb-v2/internal/modules/review"
 reviewDomain "airbnb-v2/internal/modules/review/domain"
 reviewHandlers "airbnb-v2/internal/modules/review/handlers"
 "airbnb-v2/internal/modules/user"
 userDomain "airbnb-v2/internal/modules/user/domain"
 userHandlers "airbnb-v2/internal/modules/user/handlers"
 "airbnb-v2/internal/modules/auth"
 authDomain "airbnb-v2/internal/modules/auth/domain"
 authHandlers "airbnb-v2/internal/modules/auth/handlers"
 "airbnb-v2/internal/modules/property"
 propertyDomain "airbnb-v2/internal/modules/property/domain"
 propertyHandlers "airbnb-v2/internal/modules/property/handlers"
)
...
func runApplication(ctx context.Context, builder func(http.Handler) httpServer) error {
	...
	app := fx.New(
		...
		fx.Invoke(func(lc fx.Lifecycle, router *mux.Router, reviewService reviewDomain.ReviewService, userService userDomain.UserService, authService authDomain.AuthService, propertyService propertyDomain.PropertyService, bookingService bookingDomain.BookingService) {
