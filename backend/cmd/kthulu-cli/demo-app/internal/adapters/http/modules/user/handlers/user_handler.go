...
import (
	...
	"demo-app/internal/adapters/http/modules/user/domain"
...
func (h *UserHandler) RegisterRoutes(router *mux.Router) {
	...
	sub.HandleFunc("/user", h.List).Methods("GET")
	sub.HandleFunc("/user", h.Create).Methods("POST")
	sub.HandleFunc("/user/{id}", h.GetByID).Methods("GET")
	sub.HandleFunc("/user/{id}", h.Update).Methods("PUT")
	sub.HandleFunc("/user/{id}", h.Delete).Methods("DELETE")
}
...
// @Accept       json
// @Produce      json
// @Param        input body domain.User true "User object"
