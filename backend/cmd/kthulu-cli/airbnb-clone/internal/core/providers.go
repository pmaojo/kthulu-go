...
if err != nil { return nil, err }
	...
	if err := db.AutoMigrate(&propertyDomain.Property{}, &bookingDomain.Booking{}, &reviewDomain.Review{}, &userDomain.User{}, &authDomain.Auth{}); err != nil {
		return nil, fmt.Errorf("auto-migrate failed: %w", err)
	}
	return db, nil
}
		dbPath := getEnv("SQLITE_PATH", "data/airbnb-clone.db")
